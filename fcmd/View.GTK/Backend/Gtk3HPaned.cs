...
namespace fcmd.View.GTK.Backend
{
    ...
    public class Gtk3HPaned : Xwt.HPaned
    {
        ...
        public Gtk3HPaned(Gtk.Paned panned = null) : base()
        {
            if (panned == null)
        ...
        public Gtk.HPaned gtkPaned { get { return this.backend.Widget as Gtk.HPaned; } }
    ...
    public class Gtk3HPanedBackend : Xwt.GtkBackend.PanedBackend, IPanedBackend, IWidgetBackend
    {
        ...
        public new void Initialize(Orientation dir)
        {
            if (Widget != null)
                Widget.Show();
            else
