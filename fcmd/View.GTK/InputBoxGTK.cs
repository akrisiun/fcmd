...
namespace fcmd.View.GTK
{
    ...
    public class InputBoxGTK : Xwt.Dialog
    {
        ...
        public InputBoxGTK(string AskText)
        {
        ...
        public InputBoxGTK(string AskText, string DefaultValue)
        {
            lblQuestion.Text = AskText;
        ...
        public InputBoxGTK(string AskText, string DefaultValue, Xwt.Command[] Buttons)
        {
            lblQuestion.Text = AskText;
            txtAnwser.Text = DefaultValue;
        ...
        {
            Build();
            var Backend = this.BackendHost.Backend;
            Backend.Resizable = true;
            Backend.SetSize(500, 150);
