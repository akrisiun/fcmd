...
namespace fcmd.SettingsWindowTabs
{
	class swtViewerEditor : ISettingsWindowTab
	{
		...
		public swtViewerEditor()
		{
			...
			fraViewBox.PackStart(txtExternalViewer, true, 
                WidgetPlacement.Start, WidgetPlacement.Start, 24);
			...
			ViewerSelection.ActiveRadioButtonChanged += (o, ea) => 
            { txtExternalViewer.Sensitive = optExternalViewer.Active; };
			EditorSelection.ActiveRadioButtonChanged += (o, ea) => 
            { txtExternalEditor.Sensitive = optExternalEditor.Active; };


			fraEditBox.PackStart(optInternalEditor);
			fraEditBox.PackStart(optExternalEditor);
			fraEditBox.PackStart(txtExternalEditor, true, 
                WidgetPlacement.Start, WidgetPlacement.Start, 24);
            ...
            txtExternalEditor.PlaceholderText = "nano $"; // "vim $";
