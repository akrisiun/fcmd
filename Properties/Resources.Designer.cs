...
namespace fcmd.Properties {
    ...
    internal class Resources {
        ...
        ///;Common
        ///FileCommanderVer={0} file manager, version {1}{n}© 2013-14 FC development team {0}:{2}{n}{n}For license agreement see LICENSE file.{n}For stuff used from open source projects see COPYPASTE.md file.{n}{n}Settings file: {3}{n}{n}OS: {4}{n}Framework: {5}
        ///FCVEVer1=FC built-in file viewer and editor {0}.
        ///FCVEVer2=Current VE plugin: {0}, version {1}.{2}(C) 2013-14, FC developers [rest of string was truncated]&quot;;.
        /// </summary>
